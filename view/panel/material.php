...
// tambah data
    if(isset($_POST['btn-material'])){
        ...
        $data = "'','$nm','$supId','$proyekId','$tanggal','$jenis','$harga','$jumlah','$total'";
    ...
    if(isset($_POST['hapus']) > 0){
       ...
       if( hapus("data_material","id_material",$_POST) ){
           echo "<script>
                    ...
                    document.location.href='http://localhost/primausaha/?panel=material';
                  </script>
            ";
       }
    }
...
if(isset($_POST['pekubah'])){
    ...
    if(ubahdata( $data, "data_pekerjaan", $id ) > 0 ){
            echo "<script>
                    ...
                    document.location.href='http://localhost/primausaha/?panel=pekerjaan';
                  </script>
            "; 
        }else{
            echo "<script>
